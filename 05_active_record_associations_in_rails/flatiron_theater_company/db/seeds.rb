...
CastMember.create(name:"Mariah Gale", role:"Ophelia", production:Production.find_by(title:'Hamlet'))
...
# Ticket.create(user_id: u1.id, production_id: p2.id) # more optimal bc it dosnt have to parse through the object to get the id